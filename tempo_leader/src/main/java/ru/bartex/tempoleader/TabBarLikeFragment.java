...
public class TabBarLikeFragment extends Fragment {
    ...
    public static TabBarLikeFragment newInstance(int numberItem){
        ...
        args.putInt(P.ARG_NUMBER_ITEM_LIKE,numberItem);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        int curItem = getArguments().getInt(P.ARG_NUMBER_ITEM_LIKE);
        Log.d(TAG, "TabBarLikeFragment curItem = " + curItem );
